...
# EXAMPLE:  bash anonymize_video_blackblock.sh  01NVb_sample_short.avi  01NVb_sample_test1_anonym.mp4   300 1550 60 250

# Bounding box variables: xmin xmax ymin ymax
bb=($3 $4 $5 $6)
h=` echo $6-$5 | bc`
w=` echo $4-$3 | bc`
