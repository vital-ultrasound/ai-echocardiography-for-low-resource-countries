    ...
    : QtPluginWidgetBase(parent, f)
{
    ...
    mStreamTypes = ifind::InitialiseStreamTypeSetFromString("FourChDetection");
    mIsBuilt = false;
    ...
    QObject::connect(mResetButton, &QPushButton::released,
                     this, &Widget_FourChDetection::slot_reset);
    ...
    QObject::connect(mLUSPicLabel, &AspectRatioPixmapLabel::signal_setZone,
                     this, &Widget_FourChDetection::slot_selectZone);
...
void Widget_FourChDetection::slot_reset(){
...
void Widget_FourChDetection::setArtPath(const QString &artPath)
{
    mArtPath = artPath;
    // fancy lung zones
...
void Widget_FourChDetection::slot_selectZone(int i, int s){
...
void Widget_FourChDetection::Build_AI_View(std::vector<std::string> &labelnames){
    ...
    /// This will have bar graphs of the live scan plane values
    {
        ...
        lungArtefactsTrafficLightConfig.MetadataLabelsKey = "FourChDetection_labels";
        lungArtefactsTrafficLightConfig.MetadataValuesKey = "FourChDetection_confidences";
        ...
        infoPanel->SetStreamTypesFromStr("FourChDetection");
...
void Widget_FourChDetection::BuildUserSurveyButtons(std::vector<std::string> &labelnames){
